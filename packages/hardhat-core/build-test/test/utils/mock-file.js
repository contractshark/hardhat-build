...
function mockFile({ sourceName, pragma, }) {
    ...
    return new resolver_1.ResolvedFile(sourceName, absolutePath, content, "<fake-content-hash>", lastModificationDate);
}
exports.mockFile = mockFile;
//# sourceMappingURL=mock-file.js.map