...
System.register("util/caller-package", ["find-up", "path"], function (exports_1, context_1) {
    "use strict";
    var find_up_1, path_1;
    ...
    exports_1("getClosestCallerPackage", getClosestCallerPackage);
    return {
        setters: [
            function (find_up_1_1) {
                find_up_1 = find_up_1_1;
            },
            function (path_1_1) {
                path_1 = path_1_1;
            }
...
System.register("util/strings", [], function (exports_2, context_2) {
    "use strict";
    ...
    exports_2("replaceAll", replaceAll);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("core/errors-list", [], function (exports_3, context_3) {
    "use strict";
    var ERROR_PREFIX, ERROR_RANGES, ERRORS, _PHONY_VARIABLE_TO_FORCE_ERRORS_TO_BE_OF_TYPE_ERROR_DESCRIPTOR;
    var __moduleName = context_3 && context_3.id;
    function getErrorCode(error) {
        return "" + ERROR_PREFIX + error.number;
    }
    exports_3("getErrorCode", getErrorCode);
    return {
        setters: [],
        execute: function () {
            exports_3("ERROR_PREFIX", ERROR_PREFIX = "HH");
            exports_3("ERROR_RANGES", ERROR_RANGES = {
            ...
            exports_3("ERRORS", ERRORS = {
                ...
                SOLC: {
                    ...
                    DOWNLOAD_FAILED: {
                        number: 501,
                        message: "Couldn't download compiler version %remoteVersion%. Please check your connection.",
                    ...
                    INVALID_DOWNLOAD: {
                        number: 503,
                        message: "Couldn't download compiler version %remoteVersion%. Checksum verification failed. Please check your connection.",
             ...
             */
            _PHONY_VARIABLE_TO_FORCE_ERRORS_TO_BE_OF_TYPE_ERROR_DESCRIPTOR = ERRORS;
        }
    };
});
System.register("core/errors", ["util/caller-package", "util/strings", "core/errors-list"], function (exports_4, context_4) {
    "use strict";
    var caller_package_1, strings_1, errors_list_1, inspect, CustomError, HardhatError, HardhatPluginError, NomicLabsHardhatPluginError;
    ...
    exports_4("applyErrorMessageTemplate", applyErrorMessageTemplate);
    ...
    exports_4("assertHardhatInvariant", assertHardhatInvariant);
    return {
        setters: [
            function (caller_package_1_1) {
                caller_package_1 = caller_package_1_1;
            },
            function (strings_1_1) {
                strings_1 = strings_1_1;
            },
            function (errors_list_1_1) {
                errors_list_1 = errors_list_1_1;
            }
        ],
        execute: function () {
            ...
            exports_4("CustomError", CustomError);
            HardhatError = /** @class */ (function (_super) {
            ...
            exports_4("HardhatPluginError", HardhatPluginError);
            NomicLabsHardhatPluginError = /** @class */ (function (_super) {
            ...
            exports_4("NomicLabsHardhatPluginError", NomicLabsHardhatPluginError);
        }
    };
});
